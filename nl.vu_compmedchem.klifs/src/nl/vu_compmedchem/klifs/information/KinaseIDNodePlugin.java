 ...
 */
public class KinaseIDNodePlugin extends Plugin {
    // The shared instance.
    private static KinaseIDNodePlugin plugin;

    /**
     * The constructor.
     */
    public KinaseIDNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static KinaseIDNodePlugin getDefault() {
        return plugin;
    }
